...
<body
    class="page-shell font-sans antialiased bg-white text-reka-text selection:bg-reka-blue-light selection:text-reka-blue">

    <!-- ─── TOP UTILITY BAR ─── -->
    <div
        class="hidden lg:flex bg-reka-text text-gray-300 text-xs py-2 px-6 justify-between items-center border-b border-gray-800">
        <div>
    ...
    <header id="navbar" class="premium-nav sticky top-0 z-50 w-full">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <nav class="hidden lg:flex items-center gap-8">
                <a href="/#categories"
                    class="text-sm font-semibold text-reka-text hover:text-reka-blue transition-colors">Products</a>
                <a href="/#featured"
                    class="text-sm font-semibold text-reka-text hover:text-reka-blue transition-colors">Collections</a>
                <a href="/#promotions"
                    class="text-sm font-semibold text-reka-text hover:text-reka-blue transition-colors">Inspiration</a>
                <a href="/#new-arrivals"
                    class="text-sm font-semibold text-reka-text hover:text-reka-blue transition-colors">New Arrivals</a>
                <a href="/#reviews"
                    class="text-sm font-semibold text-reka-text hover:text-reka-blue transition-colors">Offers</a>
            </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="border border-reka-border rounded-2xl p-6 flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start gap-4">
                            <div>
                                <span class="font-bold text-reka-text text-sm">Very comfortable fit!</span>
                        ...
                        <p class="text-sm text-reka-text-secondary mt-3 leading-relaxed">
                            The material is incredibly soft and the fit is true to size. Arrived quickly and looked
                ...
                <div class="border border-reka-border rounded-2xl p-6 flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start gap-4">
                            <div>
                                <span class="font-bold text-reka-text text-sm">Perfect seasonal layering</span>
                                <div class="flex text-reka-yellow mt-1">
                                    <svg class="w-3.5 h-3.5 fill-current" viewBox="0 0 20 20">
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    ...
                                    <svg class="w-3.5 h-3.5 fill-current text-gray-300" viewBox="0 0 20 20">
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    </svg>
                                </div>
                        ...
                        <p class="text-sm text-reka-text-secondary mt-3 leading-relaxed">
                            This piece layers beautifully with other wardrobe staples, and the fabric quality is
                            outstanding.
                        </p>
                    </div>
                    <div class="flex items-center gap-2 mt-4 pt-3 border-t border-reka-surface">
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-3.5 text-sm text-gray-400">
                    <li><a href="/\#categories" class="hover:text-white transition-colors">Women's Apparel</a></li>
                    <li><a href="/\#categories" class="hover:text-white transition-colors">Outerwear & Jackets</a>
                    </li>
