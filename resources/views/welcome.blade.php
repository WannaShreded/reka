...
<head>
    ...
    <title>REKA - Modern Clothing Collections</title>
...
<body class="font-sans antialiased bg-white text-reka-text selection:bg-reka-blue-light selection:text-reka-blue">
    ...
    <section id="promotions" class="py-20 bg-reka-blue text-white overflow-hidden relative">
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-animate>
                <span
                    class="inline-block bg-reka-yellow text-reka-text text-xs font-bold px-4 py-2 rounded-full mb-6 uppercase tracking-wider">Limited
                    Time Offer</span>
                <h2 class="text-4xl lg:text-5xl font-bold tracking-tight leading-tight">Up to 40% Off New Season
                    Apparel</h2>
                <p class="text-white/80 mt-6 text-lg leading-relaxed">
                    Refresh your wardrobe with curated seasonal essentials, premium knitwear, and everyday essentials.
                    Easy returns included.
                </p>
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="/category"
                        class="inline-flex items-center gap-2 bg-white text-reka-blue font-bold px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-300">
                        Shop Now
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M14 5l7 7m0 0l-7 7m7-7H3" />
            ...
            <div data-animate class="hidden lg:block">
                <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Editorial fashion flat-lay scene"
                    class="rounded-2xl shadow-2xl w-full object-cover h-[450px]">
            </div>
        </div>
    </section>
    ...
    <section id="reviews" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div data-animate class="text-center mb-16">
                ...
                <p class="text-reka-text-muted mt-3">Reviews from people who upgraded their everyday wardrobe</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div data-animate
                    ...
                    <div class="flex items-center gap-3 mt-6">
                        <img src="https://i.pravatar.cc/100?img=1" alt="Sarah M. avatar"
                ...
                <div data-animate
                    ...
                    <div class="flex items-center gap-3 mt-6">
                        <img src="https://i.pravatar.cc/100?img=3" alt="Ahmad R. avatar"
                            class="w-10 h-10 rounded-full object-cover">
                        <div>
                ...
                <div data-animate
                    ...
                    <div class="flex items-center gap-3 mt-6">
                        <img src="https://i.pravatar.cc/100?img=5" alt="Lisa W. avatar"
                            class="w-10 h-10 rounded-full object-cover">
                        <div>
    ...
    <section class="py-20 bg-reka-blue text-white relative overflow-hidden">
        ...
        <div class="max-w-xl mx-auto text-center px-6 relative z-10">
            <div data-animate class="flex flex-col items-center">
                <svg class="w-12 h-12 text-reka-yellow animate-float" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <h2 class="text-3xl font-bold mt-6 tracking-tight">Join the Family</h2>
                <p class="text-white/80 mt-3 max-w-sm">Subscribe to get design inspiration and special member sales.
                </p>

                <form id="newsletter-form"
                    class="mt-8 flex w-full max-w-md bg-white rounded-lg p-1.5 shadow-lg border border-white/20">
                    <input type="email" required placeholder="Enter your email address"
                        class="flex-grow pl-4 pr-2 py-3.5 bg-transparent border-none text-reka-text text-sm placeholder:text-gray-400 focus:outline-none w-full"
                        aria-label="Email Address">
                    <button type="submit"
                        class="bg-reka-blue hover:bg-reka-blue-dark text-white font-bold px-6 py-3.5 rounded-md transition-colors whitespace-nowrap text-sm">
                        Subscribe
                    </button>
                </form>
